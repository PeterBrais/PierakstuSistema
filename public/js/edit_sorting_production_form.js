		...
		$('#edit_sorting_production_form').validate({		
			...
			messages: {
				...
				thick: {
					...
					max: "Biezums jābūt ne vairāk kā 11 ciparus garam!",
				...
				width: {
					...
					max: "Platums jābūt ne vairāk kā 11 ciparus garam!",
				...
				length: {
					...
					max: "Garums jābūt ne vairāk kā 11 ciparus garam!",
				...
				sawn_count: {
					...
					max: "Skaits jābūt ne vairāk kā 11 ciparus garam!",
					IsValidIntegerNumber: "Skaits drīkst saturēt tikai ciparus!",
					IsValidInteger: "Skaits jābūt lielākam par nulli!",
				},
				defect_count: {
					number: "Brāķu skaits drīkst saturēt tikai ciparus!",
					min: "Brāķu skaits jābūt lielākam par nulli!",
					max: "Brāķu skaits jābūt ne vairāk kā 11 ciparus garam!",
					IsValidIntegerNumber: "Brāķu skaits drīkst saturēt tikai ciparus!",
				},
				"sorted_types[]": {
					ChosenWorkplaceDropdown: "Lūdzu, izvēlieties Šķirošanas veidu!",
				},
				"sorted_count[]": {
					required: "Lūdzu, aizpildiet 'Skaits' lauku!",
					number: "Skaits drīkst saturēt tikai ciparus!",

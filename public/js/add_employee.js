$(document).ready(function(){
	...
	var shift = '<label class="col-md-2 offset-md-1 col-form-label mt-3">Maiņa<span class="text-danger" title="Šis lauks ir obligāts"> &#10033;</span></label><div class="col-md-5 mt-3"><select class="custom-select" name="shift"><option selected value="0" style="font-weight:bold;">Izvēlieties maiņu</option><option value="1">1</option><option value="2">2</option></select></div><div class="col-md-4 mt-3"></div>';

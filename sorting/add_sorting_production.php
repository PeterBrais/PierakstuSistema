					...
					<div class="card-body">
						...
						<form id="sorting_form" action="new_sorting_production" method="POST">
							<div class="form-group row">
								...
								<div class="col-md-5">
									<input class="form-control datepicker" type="text" name="date" aria-describedby="dateArea" placeholder="2000/01/01" value="<?php echo isset($_SESSION['sorting_prod']) ? $date : $today_date; ?>">
							...
							<div class="form-group row">
								...
								<div class="col-md-5">
									<div class="row">
										<div class="col-md-6">
											<input class="form-control timepicker" type="text" name="time_from" aria-describedby="timeFromArea" value="<?php echo isset($_SESSION['sorting_prod']) ? $time_from : ''; ?>">
										</div>
										<div class="col-md-6">
											<input class="form-control timepicker" type="text" name="time_to" aria-describedby="timeFromArea" value="<?php echo isset($_SESSION['sorting_prod']) ? $time_to : ''; ?>">
										</div>
									</div>
